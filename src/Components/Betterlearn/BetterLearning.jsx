      ...
      <div className="container mx-auto px-4 py-6">
        <div className=" pt-24 flex flex-col md:flex-row justify-center gap-y-15 items-center md:justify-between">
          <div className="flex-1">
            <h4 className="text-xl mb-3">Better Learning. Better Results</h4>
            ...
            <p className="font-lexend leading-relaxed mb-4 text-left text-xl lg:pe-30 xl:pe-60">
              Welcome to an inclusive online education platform that caters to
              learners of all backgrounds, levels, and aspirations. Our platform
              is designed to be accessible, flexible, and adaptable, making it
              the perfect choice for everyone, regardless of age or prior
